      ...
      foreach ($offices as $office) {
        ...
        <tr>
          ...
          <td class="actions">
            ...
            <a class="delete" title="<?= __('Delete', 'clipe'); ?>" href="<?php echo $pedidosOnline->get_link_page("office_delete.php") . '&id=' . $office->Headquarters->id . '&profile=' . $_GET['profile']; ?>"><i class="fa fa-times"></i></a>
          </td>
        </tr>
        <?php
      }
