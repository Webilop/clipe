<div class="clipe-links pull-right">
  <a title="<?= __('Products', 'clipe'); ?>" href="<?php echo $pedidosOnline->get_link_page('product_list.php'); ?>"><i class="fa fa-barcode"></i></a>
      ...
      foreach ($categories as $category) {
        ...
        <tr>
          ...
          <td class="actions">
            ...
            <a title="<?= __('Delete', 'clipe'); ?>" class="delete" href="<?php echo $pedidosOnline->get_link_page("category_delete.php") . '&id=' . $category->ProductCategory->id ?>"><i class="fa fa-trash-o"></i></a>
          </td>
        </tr>
        <?php
      }
